...
document.write(
  ...
  <div style="align:centered;">
  <button data-dismiss="modal" type="submit" onclick="registration()" class="btn header-btn-sign ml-2" tabindex="0" style="font-family:'Rubik';font-weight:normal;font-size:24px;">Join</button>
  </div>
</div>
`
);
